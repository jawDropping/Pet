<?php
    ...
    if(isset($_POST['update_my_password']))
    {
        ...
        $view_user = $con->prepare("SELECT * FROM users_table WHERE user_email = '$user_email'");
        ...
        {
            $update_password = $con->prepare("UPDATE users_table SET user_password = '$user_pass' WHERE user_id = '$user_id'");
